  ...
  return (
    <main>
      ...
      <div className = {styles.quoteContainer}>
          ...
          <p className = {styles.description}> Santiago, because he has not caught a fish in years, is called salao by the local fishermen. Out at sea, Santiago finally catches the biggest marlin the town would have ever seen and ties it to the side of his skiff. But, on the way back to the town, sharks attack the fish until only a unrecognizable carcass that no one would appreciate remains. For a while of even refusing to even look at the fish out of shame,  Santiago remembers that he fished because he was a fisherman; not for praise or appreciation, but because he loved to do it. He realizes that he loved the fish because he fought for it and caught it, not for what people in town would think of it. </p>
      </div>
